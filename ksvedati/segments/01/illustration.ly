                                ...
                                \context Staff = "violin 1 staff"
                                {
                                    ...
                                    \context Voice = "violin 1 voice"
                                    {
                                        ...
                                        [
                                          ...
                                          %! baca.hairpin()
                                        \<
                                        \boxed-markup "guiro (hair) scratch poco a poco" 1
                                        ...
                                        ~
                                        \boxed-markup "bow on mute col legno" 1
                                        ...
                                        ~
                                        \boxed-markup "bow on mute with hair" 1
                                        ...
                                        \times 4/5
                                        {
                                          ...
                                          %! COMMENT_MEASURE_NUMBERS
                                          %! evans.SegmentMaker.comment_measure_numbers()
                                        % [violin 1 voice measure 52]
                                        r1

                                          %! COMMENT_MEASURE_NUMBERS
                                          %! evans.SegmentMaker.comment_measure_numbers()
                                        % [violin 1 voice measure 53]
                                        r1

                                          %! COMMENT_MEASURE_NUMBERS
                                          %! evans.SegmentMaker.comment_measure_numbers()
                                        % [violin 1 voice measure 54]
                                        \once \override MultiMeasureRest.transparent = ##t
                                        \stopStaff \once \override Staff.StaffSymbol.line-count = #0 \startStaff
                                        R1 * 1/4
                                        \stopStaff \startStaff
                            ...
                            \context Voice = "viola voice"
                            {
                                ...
                                \times 2/3
                                {
                                    ...
                                    - \baca-text-spanner-left-markup \trem-two-markup
                                      ...
                                      %! baca.PiecewiseCommand._call(2)
                                      %! baca.text_spanner()
                                    - \baca-text-spanner-right-markup \trem-five-markup
                                      %! SPANNER_START
                                      %! baca.PiecewiseCommand._call(2)
                                      %! baca.text_spanner()
                                    \startTextSpanOne
                            ...
                            \context Voice = "cello voice"
                            {
                                ...
                                \times 2/3
                                {
                                    ...
                                    - \baca-text-spanner-left-markup \trem-three-markup
                                      ...
                                      %! baca.PiecewiseCommand._call(2)
                                      %! baca.text_spanner()
                                    - \baca-text-spanner-right-markup \trem-two-markup
                                      %! SPANNER_START
                                      %! baca.PiecewiseCommand._call(2)
                                      %! baca.text_spanner()
                                    \startTextSpanOne
