colophon = \markup {
    ...
    \right-column {
        \line {
            Barcelona \hspace #0.75 – \hspace #0.75 Iowa City, Ia.
        }
        \line { October 2023. }
        }
    }
...
spike-top-markup = \markup {
    \combine
    \draw-circle #0.45 #0.2 ##t
    \draw-line #'(0 . 5)

    \hspace #-3.25 \raise #4.5
    \draw-line #'(4 . 0)
}


spike-middle-markup = \markup {
    \combine
    \draw-circle #0.45 #0.2 ##t
    \draw-line #'(0 . 5)

    \hspace #-3.25 \raise #2.5
    \draw-line #'(4 . 0)
}


spike-bottom-markup = \markup {
    \combine
    \draw-circle #0.45 #0.2 ##t
    \draw-line #'(0 . 5)

    \hspace #-3.25 \raise #0.5
    \draw-line #'(4 . 0)
}
